...
public enum Status {
    ...
    EXTERNAL_ADDRESS_NOT_EXIST(1300020, "external address not exists", "external address not found"),
    ...
    K8S_QUEUE_EXISTS(190001, "k8s queue {0} already exists", "队列名称[{0}]已存在"),
    ;
