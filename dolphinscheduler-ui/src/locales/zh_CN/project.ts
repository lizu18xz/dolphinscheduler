...
export default {
  ...
  node: {
    ...
    k8s_job_type: 'k8s运行job类型',
    k8s_job_type_tips: '请选择k8s运行job类型（必选）',
    k8s_input_data_path: '节点输入volume',
    k8s_output_data_path: '节点输出volume',
    k8s_output_data_path_tips: 'output data volume',
    k8s_input_data_path_tips: 'input data volume',
    command: '容器执行命令',
