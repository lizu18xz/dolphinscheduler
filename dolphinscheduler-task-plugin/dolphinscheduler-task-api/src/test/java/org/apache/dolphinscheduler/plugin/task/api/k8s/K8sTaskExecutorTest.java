...
public class K8sTaskExecutorTest {
    ...
    public static void main(String[] args) {
        try {
            ...
            GenericKubernetesResourceList list = resourceMixedOperation
                    .inNamespace("yiqi").list();
            List<GenericKubernetesResource> items = list.getItems();
            Optional<GenericKubernetesResource> first = items.stream()
                    .filter(job -> job.getMetadata().getName().equals("101-133"))
                    .findFirst();
    ...
    public static CustomResourceDefinitionContext getQueueJobCustomResourceDefinitionContext() {
